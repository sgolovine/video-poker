...
interface CardSlotProps {
  ...
  readonly showKeyboardShortcut: boolean;
...
export function CardSlot({
  ...
  const imageClassName = [
    ...
    held
      ...
      : '',
    selected && !disabled
      ? 'ring-4 ring-[#ffff2f] ring-offset-4 ring-offset-[#000099] max-[760px]:ring-2 max-[760px]:ring-offset-2'
      : '',
  ].join(' ');
  ...
  return (
    ...
    >
      <span className="held-label grid min-h-8 grid-cols-[1fr_auto_1fr] items-center gap-1 text-[28px] leading-none font-bold text-white [text-shadow:2px_2px_0_#0036a1,0_0_2px_#000]">
        ...
        {showKeyboardShortcut ? (
          <Kbd className="justify-self-end border border-[#cab726] bg-[#ffe63d] text-[11px] font-black text-[#070707] [text-shadow:none] max-[760px]:h-4 max-[760px]:min-w-4 max-[760px]:px-0.5 max-[760px]:text-[9px]">
            {shortcut}
          </Kbd>
        ) : (
          <span aria-hidden="true" />
